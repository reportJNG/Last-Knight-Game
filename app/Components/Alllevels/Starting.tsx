...
export default function Starting({ begin, bossname, leave }: Startingprops) {
  ...
  return (
    <div className={styles.container}>
      {" "}
      {/**here need to choose nice uibackground for it */}
      {!confirme && (
        <div className={styles.firstpage}>
          <div className={styles.midscreentitle}>
          ...
          <div className={styles.buttonhandlerdownmid}>
            ...
            <button className={styles.fight} onClick={() => begin()}>
              Fight !
            </button>
          </div>
        </div>
      )}
      {/**first page is fight or leave */}
      {confirme && (
        <div className={styles.secondpage}>
          ...
          <div className={styles.confirmContent}>
            ...
            <div className={styles.buttonContainer}>
              ...
              <button className={styles.confirmButton} onClick={leave}>
                Leave
              </button>
            </div>
          </div>
      ...
      {/**second page to confirme leaving */}
    </div>
  );
}
